...
- Apply Excel formulas and functions to derive insights.
...
Used a variety of Excel functions to perform calculations, data lookups, and date analysis:

- `SUM()` for aggregating sales figures.
- `SUMIF()` for conditional sales calculations.
- `AVERAGE()` for calculating overall averages.
- `AVERAGEIF()` for conditional average analysis.
